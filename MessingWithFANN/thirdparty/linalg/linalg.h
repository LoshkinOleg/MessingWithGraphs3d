...
namespace linalg
{
    ...
    template<class A, class B> constexpr apply_t<detail::min, A, B> linalg_min(const A & a, const B & b) { return apply(detail::min{}, a, b); }
    template<class A, class B> constexpr apply_t<detail::max, A, B> linalg_max(const A & a, const B & b) { return apply(detail::max{}, a, b); }
